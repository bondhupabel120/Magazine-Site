        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu" style="margin-top: 30px">
                    ...
                    <li>
                        <a href="{{ route('register-admin') }}"><i class="fa fa-bar-chart-o fa-fw"></i> Register All Admin</a>
                    </li>
                    <li>
                        <a href="{{ route('register-user') }}"><i class="fa fa-bar-chart-o fa-fw"></i> Registered User</a>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{ route('manage-story') }}">Story</a>
                            </li>
                            <li>
                                <a href="{{ route('manage-poem') }}">Poem</a>
                            </li>
                            <li>
                                <a href="{{ route('manage-joke') }}">Jokes</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="{{ route('manage-comment') }}"><i class="fa fa-bar-chart-o fa-fw"></i> Manage Comment</a>
                    </li>
                    <li>
                        <a href="{{ route('manage-contact') }}"><i class="fa fa-bar-chart-o fa-fw"></i> Contact</a>
                    </li>
