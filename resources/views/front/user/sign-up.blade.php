        ...
        <div class="main-agileinfo">
            <div class="agileits-top">
                <form action="{{ route('new-sign-up') }}" method="POST">
                    ...
                    <input class="text email" type="email" name="email" placeholder="Email" required="" onblur="emailCheck(this.value);">
                    <input class="text" type="password" name="password" placeholder="Password" required="">
                    <input class="text w3lpass" type="text" name="phone" placeholder="Phone Number" required>
                    ...
                    <input type="submit" id="regBtn" style="width: 94%" value="SIGNUP">
                </form>
                <p>If you have Login? <a href="{{ route('visitor-login') }}" class="text-warning"> Login Now!</a></p>
            </div>
        </div>
