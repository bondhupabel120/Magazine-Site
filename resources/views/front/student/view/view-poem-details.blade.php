                ...
                <div class="col-lg-8 post-list">
                    ...
                    <div class="single-post-wrap">
                        <div class="content-wrap">
                            ...
                            <ul class="meta pb-20">
                                <li><a href="#"><span class="lnr lnr-user"></span>{{ $poems->name }}</a></li>
                                <li class="float-right"><a><span class="lnr lnr-calendar-full"></span>{{ $poems->created_at->format('j F Y') }}</a></li><br/>
                                <li><a href="#"><span class="lnr lnr-arrow-right-circle"></span>Dept. of {{ $poems->department }}</a></li><br/>
                                <li><a href="#"><span class="lnr lnr-arrow-right-circle"></span>ID : {{ $poems->student_id }}</a></li>
                            </ul>
                            <hr/>
                            <p>
                                {!! $poems->description !!}
                    ...
                    <div class="sidebars-area">
                        <div class="single-sidebar-widget editors-pick-widget">
                            ...
                            <div class="editors-pick-post">
                                ...
                                @foreach($details_poem_ones as $details_poem_one)
                                    ...
                                    <div class="details">
                                        <a href="{{ route('poem-details', ['id'=>$details_poem_one->id]) }}">
                                            <h4 class="mt-20">{{ $details_poem_one->heading }}</h4>
                                        </a>
                                        <ul class="meta">
                                            <li><a href="#"><span class="lnr lnr-user"></span>{{ $details_poem_one->name }}</a></li>
                                            <li><a><span class="lnr lnr-calendar-full"></span>{{ $details_poem_one->created_at->format('j F Y') }}</a></li>
                                        </ul>
                                    </div>
                                @endforeach
