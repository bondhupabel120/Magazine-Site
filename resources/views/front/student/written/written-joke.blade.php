        ...
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                <div class="card-heading">
                    <h2 class="title">Written Your Jokes</h2>
                </div>
                <div class="card-body">
                    <form action="{{ route('new-written-joke') }}" method="POST">
                        @csrf
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            <div class="name">Heading of Jokes<span class="text-danger"> *</span></div>
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="heading" placeholder="Enter Your Jokes Heading">
                        ...
                        <div class="form-row">
                            <div class="name">Description of Jokes<span class="text-danger"> *</span></div>
                            <div class="value">
                                <div class="input-group">
                                    <textarea class="input--style-5 btn-block" type="text" name="description" placeholder="Enter Your Jokes Description"></textarea>
